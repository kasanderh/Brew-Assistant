...
import com.kasanderh.newcoffeeapp.databinding.ActivityCoffeeTipsBinding

class CoffeeTipsActivity : AppCompatActivity() {

    private lateinit var bottomSheetBehavior: BottomSheetBehavior<ConstraintLayout>
    private lateinit var binding: ActivityCoffeeTipsBinding

    private lateinit var chronometer: Chronometer
    private val logTag: String = "CoffeeTipsActivity"

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)

        // View binding for the activity_aeropress which includes bottom sheet layout
        binding = ActivityCoffeeTipsBinding.inflate(layoutInflater)
