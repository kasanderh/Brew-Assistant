...
import com.kasanderh.newcoffeeapp.databinding.ActivityColdBrewBinding

class ColdBrewActivity : AppCompatActivity() {

    private lateinit var bottomSheetBehavior: BottomSheetBehavior<ConstraintLayout>
    private lateinit var binding: ActivityColdBrewBinding

    private lateinit var chronometer: Chronometer
    private val logTag: String = "ColdBrewActivity"

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)

        // View binding for the activity_aeropress
        binding = ActivityColdBrewBinding.inflate(layoutInflater)
